...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionFilterCategoryList 
    {
        /// <summary>
        ...
        /// The list of transaction categories that should be returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>The list of transaction categories that should be returned or affected by a read, update or delete request. </value>
