...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class MicroDepositFundingFilterMicroDepositIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A micro deposit ID that should have its associated records either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A micro deposit ID that should have its associated records either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="microDepositId", EmitDefaultValue=false)]
        public List<string> MicroDepositId { get; set; }
