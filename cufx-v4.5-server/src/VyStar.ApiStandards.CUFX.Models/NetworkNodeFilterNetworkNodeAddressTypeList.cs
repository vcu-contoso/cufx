...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class NetworkNodeFilterNetworkNodeAddressTypeList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Collection of network node types to return in a filter request. </value>
        [DataMember(Name="networkNodeAddressType", EmitDefaultValue=false)]
        public List<NetworkNodeAddressType> NetworkNodeAddressType { get; set; }
