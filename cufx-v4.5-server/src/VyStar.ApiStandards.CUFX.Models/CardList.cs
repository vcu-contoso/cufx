...
{ 
    /// <summary>
    /// The cards collection/array contains all the cards, for instance, that the credential set is authorized to access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
