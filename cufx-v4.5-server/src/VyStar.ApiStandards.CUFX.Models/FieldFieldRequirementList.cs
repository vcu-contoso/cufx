...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FieldFieldRequirementList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Criteria that must be met for the field to be considered valid. </value>
        [DataMember(Name="fieldRequirement", EmitDefaultValue=false)]
