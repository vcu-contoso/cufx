...
{ 
    /// <summary>
    /// The list of fee IDs that should have their associated transaction records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class FeeScheduleFilterFeeIdList 
    {
        /// <summary>
