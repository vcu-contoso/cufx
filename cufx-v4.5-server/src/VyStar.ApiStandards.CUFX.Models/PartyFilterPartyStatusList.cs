...
{ 
    /// <summary>
    /// The list of party statuses that should have their associated parties either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class PartyFilterPartyStatusList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A party status that should have its associated parties either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A party status that should have its associated parties either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="partyStatus", EmitDefaultValue=false)]
        public List<string> PartyStatus { get; set; }
