...
{ 
    /// <summary>
    /// A collection of party IDâ€™s that uniquely identify each party associated to this deposit and additional fields on how the party relates to the deposit. This list is in addition to the relationship parties if available. 
    /// </summary>
    [DataContract]
    public partial class DepositDepositPartyList 
    {
        /// <summary>
        ...
        [DataMember(Name="depositParty", EmitDefaultValue=false)]
        public List<DepositParty> DepositParty { get; set; }
