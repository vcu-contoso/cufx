...
{ 
    /// <summary>
    /// The accounts collection/array contains all the accounts, for instance, that the credential set is authorized to access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
