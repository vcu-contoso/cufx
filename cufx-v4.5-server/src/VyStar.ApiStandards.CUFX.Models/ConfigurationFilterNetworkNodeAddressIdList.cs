...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationFilterNetworkNodeAddressIdList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Collection of network node ids to return in a filter request. </value>
        [DataMember(Name="networkNodeId", EmitDefaultValue=false)]
        public List<string> NetworkNodeId { get; set; }
