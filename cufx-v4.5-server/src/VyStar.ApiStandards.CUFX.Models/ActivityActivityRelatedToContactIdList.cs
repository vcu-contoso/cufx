...
{ 
    /// <summary>
    /// The list of contact IDs that should have their associated contacts either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class ActivityActivityRelatedToContactIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A contact ID that should have its associated contacts either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A contact ID that should have its associated contacts either returned or affected by a read, update or delete request. </value>
