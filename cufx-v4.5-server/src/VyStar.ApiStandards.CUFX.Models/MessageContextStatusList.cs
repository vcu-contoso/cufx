...
{ 
    /// <summary>
    /// The message response list collection/array contains all the messages returned when a service point was called. 
    /// </summary>
    [DataContract]
    public partial class MessageContextStatusList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A collection of fields that represents an individual response message that occurred when a service point was called. 
        /// </summary>
        /// <value>A collection of fields that represents an individual response message that occurred when a service point was called. </value>
