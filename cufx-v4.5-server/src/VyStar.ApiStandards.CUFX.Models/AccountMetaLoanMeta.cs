...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AccountMetaLoanMeta 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Interest rate that is used for calculations. Most of the time you would only use rate AND APR when there is a split or variable rate. Value is formatted as a percentile. A passed value of 4.5 is equivalent to 0.045 actual. 4.500 may be displayed as 4.500% or 4.5% depending on the user interface. Decimals available: 999.999 </value>
        ...
        /// <summary>
        /// Gets or Sets LastStatemntBalance
        /// </summary>
        [DataMember(Name="lastStatemntBalance", EmitDefaultValue=false)]
        public AccountAccountEscheatAmount LastStatemntBalance { get; set; }
