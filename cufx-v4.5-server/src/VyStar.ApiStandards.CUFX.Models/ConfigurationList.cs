...
{ 
    /// <summary>
    /// The list of configurations available in the CUFX instance. There will be one configuration for one or more financial institutions. These configurations can be utilized for whatever purpose the endpoint needs to break out into multiple configurations.  For example, It may be necessary to have multiple test configurations in the same endpoint. 
    /// </summary>
    [DataContract]
    public partial class ConfigurationList 
    {
        ...
        /// <summary>
        /// The list of supported financial institutions, services, methods, limitations and options within the CUFX instance. 
        /// </summary>
        /// <value>The list of supported financial institutions, services, methods, limitations and options within the CUFX instance. </value>
        [DataMember(Name="configuration", EmitDefaultValue=false)]
        public List<ModelConfiguration> VarConfiguration { get; set; }
