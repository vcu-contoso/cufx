...
{ 
    /// <summary>
    /// The bill payee collection/array contains all the payees, for instance, that the credential set is authorized to access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
    public partial class BillPayeeList 
    {
        ...
        /// <summary>
        /// Gets or Sets BillPayee
        /// </summary>
        [DataMember(Name="billPayee", EmitDefaultValue=false)]
        public List<BillPayee> BillPayee { get; set; }
