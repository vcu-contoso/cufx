...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class LoanPartyLoanPartyRelationshipTypeCollateralGrantor 
    {
        /// <summary>
        /// Specifies whether the party has a relationship status of collateral grantor on the account. 
        /// </summary>
        /// <value>Specifies whether the party has a relationship status of collateral grantor on the account. </value>
        [DataMember(Name="isCollateralGrantor", EmitDefaultValue=true)]
        public bool IsCollateralGrantor { get; set; }
