...
{ 
    /// <summary>
    /// The documents collection/array list contains all the documents or document templates, for instance, that the credential set is authorized to access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
