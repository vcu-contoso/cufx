...
{ 
    /// <summary>
    /// Collection of account identifications to associate accounts affected by a read, update or delete request. This filter supports financial institutions that have a complex account identification structure to establish a unique key. 
    /// </summary>
    [DataContract]
    public partial class AccountFilterAccountIdentificationList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The set of account identification elements to specify accounts for a read, update or delete request. </value>
        [DataMember(Name="accountIdentification", EmitDefaultValue=false)]
        public List<AccountIdentification> AccountIdentification { get; set; }
