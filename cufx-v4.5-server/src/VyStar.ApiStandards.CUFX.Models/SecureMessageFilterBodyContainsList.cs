...
{ 
    /// <summary>
    /// The list of bodyContains strings somewhere within its body and that should have their associated secure messages either returned or affected by a read, update or delete secure message request. 
    /// </summary>
    [DataContract]
    public partial class SecureMessageFilterBodyContainsList 
    {
        /// <summary>
        ...
        /// <summary>
        /// String contained in the body that should have their associated secure messages either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>String contained in the body that should have their associated secure messages either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="bodyContains", EmitDefaultValue=false)]
