...
{ 
    /// <summary>
    /// List of additional non-standard sources of income (child support, investments, e-bay, etc.). 
    /// </summary>
    [DataContract]
    public partial class PartyCharacteristicsIndividualAdditionalIncomeList 
    {
        /// <summary>
        ...
        /// <summary>
        /// Describes additional non-standard sources of income (child support, investments, e-bay, etc.). 
        /// </summary>
        /// <value>Describes additional non-standard sources of income (child support, investments, e-bay, etc.). </value>
        [DataMember(Name="additionalIncome", EmitDefaultValue=false)]
        public List<AdditionalIncome> AdditionalIncome { get; set; }
