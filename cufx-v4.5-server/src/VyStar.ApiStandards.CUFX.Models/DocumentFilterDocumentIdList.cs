...
{ 
    /// <summary>
    /// The list of document IDs that should have their associated documents either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class DocumentFilterDocumentIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A document ID that should have its associated documents either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A document ID that should have its associated documents either returned or affected by a read, update or delete request. </value>
