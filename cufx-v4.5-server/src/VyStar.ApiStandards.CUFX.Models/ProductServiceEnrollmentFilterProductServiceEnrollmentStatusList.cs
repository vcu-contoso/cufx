...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ProductServiceEnrollmentFilterProductServiceEnrollmentStatusList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The productServiceEnrollment status </value>
        [DataMember(Name="productServiceEnrollmentStatus", EmitDefaultValue=false)]
        public List<string> ProductServiceEnrollmentStatus { get; set; }
