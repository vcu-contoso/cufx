...
{ 
    /// <summary>
    /// The list of withholding information. 
    /// </summary>
    [DataContract]
    public partial class AccountWithholdingsInfoList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Fields related to require tax withholding information. </value>
        [DataMember(Name="withholdingInfo", EmitDefaultValue=false)]
        public List<WithholdingInfo> WithholdingInfo { get; set; }
