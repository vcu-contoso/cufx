...
{ 
    /// <summary>
    /// The list of relationship statuses that should have their accounts either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class RelationshipFilterRelationshipStatusList 
    {
        /// <summary>
        ...
        [DataMember(Name="relationshipStatus", EmitDefaultValue=false)]
        public List<RelationshipStatus> RelationshipStatus { get; set; }
