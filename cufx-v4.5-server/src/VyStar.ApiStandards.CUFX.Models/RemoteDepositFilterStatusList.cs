...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RemoteDepositFilterStatusList 
    {
        /// <summary>
        ...
        /// The list of remote deposit statuses that should be returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>The list of remote deposit statuses that should be returned or affected by a read, update or delete request. </value>
        [DataMember(Name="status", EmitDefaultValue=false)]
        public List<RemoteDepositStatus> Status { get; set; }
