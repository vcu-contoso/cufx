...
{ 
    /// <summary>
    /// The list of filter options for services requesting system status data. The options can be used in combination or by themselves. It is up to the data source to either return or affect the data requested or return a standard error identifying why the request was rejected. 
    /// </summary>
    [DataContract]
    public partial class SystemStatusFilter 
    {
        ...
        /// <summary>
        /// Gets or Sets SystemStatusList
        /// </summary>
        [DataMember(Name="systemStatusList", EmitDefaultValue=false)]
        public SystemStatusFilterSystemStatusList SystemStatusList { get; set; }
