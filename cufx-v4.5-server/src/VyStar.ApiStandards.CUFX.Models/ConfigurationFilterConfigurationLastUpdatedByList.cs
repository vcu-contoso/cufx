...
{ 
    /// <summary>
    /// The list of users that last modified a configuration that should have their associated configurations either returned or affected by a read, update or delete configuration request. 
    /// </summary>
    [DataContract]
    public partial class ConfigurationFilterConfigurationLastUpdatedByList 
    {
        /// <summary>
        ...
        /// <summary>
        /// The unique identifier for the user that last modified the configuration. 
        /// </summary>
        /// <value>The unique identifier for the user that last modified the configuration. </value>
        [DataMember(Name="configurationLastModifiedBy", EmitDefaultValue=false)]
        public List<string> ConfigurationLastModifiedBy { get; set; }
