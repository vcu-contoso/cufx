...
{ 
    /// <summary>
    /// The list of document sub types that should have their associated documents either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class DocumentFilterDocumentSubTypeList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A document sub type that should have its associated documents either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A document sub type that should have its associated documents either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="documentSubType", EmitDefaultValue=false)]
        public List<string> DocumentSubType { get; set; }
