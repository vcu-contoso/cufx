...
{ 
    /// <summary>
    /// The list of bill pay global IDs that should have their associated bill pay records that are global either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class BillPayeeFilterBillPayeeGlobalIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A bill pay global ID that should have its associated bill pay global id either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A bill pay global ID that should have its associated bill pay global id either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="billPayeeGlobalId", EmitDefaultValue=false)]
        public List<string> BillPayeeGlobalId { get; set; }
