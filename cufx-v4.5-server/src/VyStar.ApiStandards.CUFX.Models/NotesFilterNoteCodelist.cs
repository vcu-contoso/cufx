...
{ 
    /// <summary>
    /// The list of note codess that should have their associated records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class NotesFilterNoteCodelist 
    {
        /// <summary>
        ...
        /// <summary>
        /// A Note Code that should have its associated records either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A Note Code that should have its associated records either returned or affected by a read, update or delete request. </value>
