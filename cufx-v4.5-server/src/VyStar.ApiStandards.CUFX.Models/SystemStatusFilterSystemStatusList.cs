...
{ 
    /// <summary>
    /// The system status collection/array list contains all the system statuses that are authorized for access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
    public partial class SystemStatusFilterSystemStatusList 
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets SystemState
        /// </summary>
        [DataMember(Name="systemState", EmitDefaultValue=false)]
        public List<SystemState> SystemState { get; set; }
