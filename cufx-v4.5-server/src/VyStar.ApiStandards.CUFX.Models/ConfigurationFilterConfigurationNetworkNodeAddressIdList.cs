...
{ 
    /// <summary>
    /// The list of Configuration network node address IDs that should have their associated configurations either returned or affected by a read, update or delete configuration request. 
    /// </summary>
    [DataContract]
    public partial class ConfigurationFilterConfigurationNetworkNodeAddressIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// The unique identifier for the configuration, financial institution and network node address. 
        /// </summary>
        /// <value>The unique identifier for the configuration, financial institution and network node address. </value>
        [DataMember(Name="configurationNetworkNodeAddressId", EmitDefaultValue=false)]
        public List<string> ConfigurationNetworkNodeAddressId { get; set; }
