...
{ 
    /// <summary>
    /// The list of payments or transfers occurrence IDs that should have their associated occurrence ID either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class BillPaymentFilterOccurrenceIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// An occurrence ID that should have its associated payments or transfers either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>An occurrence ID that should have its associated payments or transfers either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="occurrenceId", EmitDefaultValue=false)]
        public List<string> OccurrenceId { get; set; }
