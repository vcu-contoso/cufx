...
{ 
    /// <summary>
    /// The artifacts collection/array contains all the artifacts, for instance, that the credential set is authorized to access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
    public partial class DocumentDocumentArtifactList 
    {
        /// <summary>
