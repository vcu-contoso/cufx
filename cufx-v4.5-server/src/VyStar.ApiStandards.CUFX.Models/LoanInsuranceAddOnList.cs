...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class LoanInsuranceAddOnList 
    {
        /// <summary>
        ...
        /// <summary>
        /// Details relating to each insurance add on placed on the loan. It is insurance directly related to the loan. 
        /// </summary>
        /// <value>Details relating to each insurance add on placed on the loan. It is insurance directly related to the loan. </value>
        [DataMember(Name="insuranceAddOn", EmitDefaultValue=false)]
        public List<InsuranceAddOn> InsuranceAddOn { get; set; }
