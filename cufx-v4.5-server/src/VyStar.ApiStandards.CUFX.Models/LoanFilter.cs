...
{ 
    /// <summary>
    /// The list of filter options for services requesting loan data.  The options can be used in combination or by themselves.  It is up to the data source to either return or affect the data requested or return a standard error identifying why the request was rejected. 
    /// </summary>
    [DataContract]
    public partial class LoanFilter 
    {
        ...
        /// <summary>
        /// Gets or Sets LoanCategoryList
        /// </summary>
        [DataMember(Name="loanCategoryList", EmitDefaultValue=false)]
        public LoanFilterLoanCategoryList LoanCategoryList { get; set; }
