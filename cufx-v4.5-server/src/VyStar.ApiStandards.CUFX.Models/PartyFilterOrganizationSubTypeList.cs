...
{ 
    /// <summary>
    /// The list of organization sub types that should have their associated parties either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class PartyFilterOrganizationSubTypeList 
    {
        /// <summary>
        ...
        /// <summary>
        /// An organization type that should have its associated parties either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>An organization type that should have its associated parties either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="organizationSubType", EmitDefaultValue=false)]
        public List<string> OrganizationSubType { get; set; }
