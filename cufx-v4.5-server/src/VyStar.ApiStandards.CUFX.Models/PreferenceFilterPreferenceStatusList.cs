...
{ 
    /// <summary>
    /// The list of preference statuses that should have their preference records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class PreferenceFilterPreferenceStatusList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A preference status that should have its associated preference either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A preference status that should have its associated preference either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="preferenceStatus", EmitDefaultValue=false)]
        public List<PreferenceStatus> PreferenceStatus { get; set; }
