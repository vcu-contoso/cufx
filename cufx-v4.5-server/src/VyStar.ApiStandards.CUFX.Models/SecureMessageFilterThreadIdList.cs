...
{ 
    /// <summary>
    /// The list of thread IDs that should have their associated secure messages either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class SecureMessageFilterThreadIdList 
    {
        /// <summary>
