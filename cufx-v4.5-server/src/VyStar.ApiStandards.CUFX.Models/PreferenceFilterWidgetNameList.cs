...
{ 
    /// <summary>
    /// The list of widget names that should have their preference records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class PreferenceFilterWidgetNameList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A widget name that should have its associated preference either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A widget name that should have its associated preference either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="widgetName", EmitDefaultValue=false)]
        public List<string> WidgetName { get; set; }
