...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class MicroDepositFundingFilterMicroDepositFundingIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A micro funding deposit ID that should have its associated records either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A micro funding deposit ID that should have its associated records either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="microDepositFundingId", EmitDefaultValue=false)]
        public List<string> MicroDepositFundingId { get; set; }
