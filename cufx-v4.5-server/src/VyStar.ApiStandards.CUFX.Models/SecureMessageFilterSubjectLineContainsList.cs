...
{ 
    /// <summary>
    /// The list of secure message subjects that should have their associated secure messages either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class SecureMessageFilterSubjectLineContainsList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A secure message subject line that should have its associated secure messages either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A secure message subject line that should have its associated secure messages either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="subjectLine", EmitDefaultValue=false)]
        public List<string> SubjectLine { get; set; }
