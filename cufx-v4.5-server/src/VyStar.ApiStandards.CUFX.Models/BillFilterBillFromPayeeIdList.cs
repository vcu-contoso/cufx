...
{ 
    /// <summary>
    /// The list of bill pay IDs that should have their associated bill pay records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class BillFilterBillFromPayeeIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A bill pay ID that should have its associated bill pay id either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A bill pay ID that should have its associated bill pay id either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="billPayeeId", EmitDefaultValue=false)]
        public List<string> BillPayeeId { get; set; }
