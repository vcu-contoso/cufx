...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AppFilterParameterScopeList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Collection of app parameter scopes to return in a filter request. </value>
        [DataMember(Name="parameterScope", EmitDefaultValue=false)]
        public List<ParameterScope> ParameterScope { get; set; }
