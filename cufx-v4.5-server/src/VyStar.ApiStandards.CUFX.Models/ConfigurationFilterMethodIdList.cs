...
{ 
    /// <summary>
    /// The list of Method IDs that should have their associated configurations either returned or affected by a read, update or delete configuration request. 
    /// </summary>
    [DataContract]
    public partial class ConfigurationFilterMethodIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// unique identification for the method. 
        /// </summary>
        /// <value>unique identification for the method. </value>
        [DataMember(Name="MethodId", EmitDefaultValue=false)]
        public List<string> MethodId { get; set; }
