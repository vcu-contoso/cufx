...
{ 
    /// <summary>
    /// The list of loan account categories that should have their associated loans either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class LoanFilterLoanCategoryList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A loan account category that should have its associated loans either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A loan account category that should have its associated loans either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="loanCategory", EmitDefaultValue=false)]
        public List<LoanAccountCategory> LoanCategory { get; set; }
