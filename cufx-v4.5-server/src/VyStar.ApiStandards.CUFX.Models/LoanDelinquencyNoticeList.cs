...
{ 
    /// <summary>
    /// Details related to delinquency notices. This describes/details the actions taken when the loan is in a delinquent state. 
    /// </summary>
    [DataContract]
    public partial class LoanDelinquencyNoticeList 
    {
        /// <summary>
        ...
        /// <summary>
        /// Details related to each delinquency notice. It describes/details the actions taken when the loan is in a delinquent state. 
        /// </summary>
        /// <value>Details related to each delinquency notice. It describes/details the actions taken when the loan is in a delinquent state. </value>
        [DataMember(Name="delinquencyNotice", EmitDefaultValue=false)]
        public List<DelinquencyNotice> DelinquencyNotice { get; set; }
