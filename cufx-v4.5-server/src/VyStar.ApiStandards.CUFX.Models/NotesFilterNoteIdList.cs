...
{ 
    /// <summary>
    /// The list of note IDs that should have their associated accounts either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class NotesFilterNoteIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// An Note ID that should have its associated records either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>An Note ID that should have its associated records either returned or affected by a read, update or delete request. </value>
