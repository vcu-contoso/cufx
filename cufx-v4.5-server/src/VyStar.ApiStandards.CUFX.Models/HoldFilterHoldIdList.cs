...
{ 
    /// <summary>
    /// The list of hold IDs that should have their associated hold records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class HoldFilterHoldIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A hold ID that should have its associated hold id either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A hold ID that should have its associated hold id either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="holdId", EmitDefaultValue=false)]
        public List<string> HoldId { get; set; }
