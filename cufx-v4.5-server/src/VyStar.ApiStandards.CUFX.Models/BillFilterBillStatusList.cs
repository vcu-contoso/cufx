...
{ 
    /// <summary>
    /// The list of bill statuses that should have their associated bill records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class BillFilterBillStatusList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A bill status that should have its associated bill records either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A bill status that should have its associated bill records either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="billStatus", EmitDefaultValue=false)]
        public List<BillStatus> BillStatus { get; set; }
