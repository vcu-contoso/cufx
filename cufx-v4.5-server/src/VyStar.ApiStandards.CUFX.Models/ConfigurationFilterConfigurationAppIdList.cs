...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationFilterConfigurationAppIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A list of configuration app IDs that point to how an app as its installed/specialized in the configuration. 
        /// </summary>
        /// <value>A list of configuration app IDs that point to how an app as its installed/specialized in the configuration. </value>
        [DataMember(Name="configurationAppId", EmitDefaultValue=false)]
        public List<string> ConfigurationAppId { get; set; }
