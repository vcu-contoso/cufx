...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RemoteDepositFilterActionList 
    {
        /// <summary>
        ...
        /// <summary>
        /// The list of actions that may be filtered to identify remote deposits to be affected by a read, update or delete request. Any single remote deposit will only have one valid action in progress at a given time. 
        /// </summary>
        /// <value>The list of actions that may be filtered to identify remote deposits to be affected by a read, update or delete request. Any single remote deposit will only have one valid action in progress at a given time. </value>
        [DataMember(Name="action", EmitDefaultValue=false)]
        public List<RemoteDepositAction> Action { get; set; }
