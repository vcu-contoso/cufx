...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionFilterSourceList 
    {
        /// <summary>
        ...
        /// The list of transaction sources that should be returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>The list of transaction sources that should be returned or affected by a read, update or delete request. </value>
        [DataMember(Name="source", EmitDefaultValue=false)]
        public List<TransactionSource> Source { get; set; }
