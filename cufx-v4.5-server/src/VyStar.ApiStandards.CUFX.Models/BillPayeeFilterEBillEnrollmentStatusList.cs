...
{ 
    /// <summary>
    /// The list of ebill enrollment statuses that should have their associated bill payee records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class BillPayeeFilterEBillEnrollmentStatusList 
    {
        /// <summary>
        ...
        /// <summary>
        /// An ebill enrollment status that should have its associated bill payee records either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>An ebill enrollment status that should have its associated bill payee records either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="eBillEnrollmentStatus", EmitDefaultValue=false)]
        public List<EBillEnrollmentStatus> EBillEnrollmentStatus { get; set; }
