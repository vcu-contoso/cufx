...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BillPaymentOccurrence 
    {
        /// <summary>
        ...
        /// <summary>
        /// The expected debit date of bill payment. The date/time should be ISO 8601 UTC format.  yyyy-mm-ddThh:mmZ (2011-03-28T12:00Z) or yyyy-mm-dd (2011-03-28) formats are supported.  The time is assumed to be 00:00Z if omitted. 
        /// </summary>
        /// <value>The expected debit date of bill payment. The date/time should be ISO 8601 UTC format.  yyyy-mm-ddThh:mmZ (2011-03-28T12:00Z) or yyyy-mm-dd (2011-03-28) formats are supported.  The time is assumed to be 00:00Z if omitted. </value>
        [DataMember(Name="expectedDebitDateTime", EmitDefaultValue=false)]
        public string ExpectedDebitDateTime { get; set; }
        ...
        /// </summary>
        /// <value>True if the payment has had a stop payment requested; false if a stop payment has not been requested. </value>
        [DataMember(Name="isStopRequested", EmitDefaultValue=true)]
        public bool IsStopRequested { get; set; }

        /// <summary>
        /// The date that the bill payment was stopped. The date/time should be ISO 8601 UTC format.  yyyy-mm-ddThh:mmZ (2011-03-28T12:00Z) or yyyy-mm-dd (2011-03-28) formats are supported.  The time is assumed to be 00:00Z if omitted. 
        /// </summary>
        /// <value>The date that the bill payment was stopped. The date/time should be ISO 8601 UTC format.  yyyy-mm-ddThh:mmZ (2011-03-28T12:00Z) or yyyy-mm-dd (2011-03-28) formats are supported.  The time is assumed to be 00:00Z if omitted. </value>
        [DataMember(Name="checkStoppedDate", EmitDefaultValue=false)]
        public string CheckStoppedDate { get; set; }

        /// <summary>
        /// The number of times that the bill payment has failed to process due to insufficient funds. 
        /// </summary>
        /// <value>The number of times that the bill payment has failed to process due to insufficient funds. </value>
        [DataMember(Name="nsfCount", EmitDefaultValue=true)]
