...
{ 
    /// <summary>
    /// The parties collection/array contains all the parties, for instance, that the credential set is authorized to access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
    public partial class ActivityActivityRelatedToUnknownPartyList 
    {
        /// <summary>
