...
{ 
    ...
    public partial class RelationshipList 
    {
        ...
        /// <summary>
        /// The relationships collection/array contains all the relationships, for instance, that the credential set is authorized to access at the Institution based on applied filters. 
        /// </summary>
        /// <value>The relationships collection/array contains all the relationships, for instance, that the credential set is authorized to access at the Institution based on applied filters. </value>
