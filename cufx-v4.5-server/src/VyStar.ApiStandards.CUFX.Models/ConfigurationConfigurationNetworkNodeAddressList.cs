...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationConfigurationNetworkNodeAddressList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A list of network node addresses that are in or comprise the configuration. 
        /// </summary>
        /// <value>A list of network node addresses that are in or comprise the configuration. </value>
        [DataMember(Name="configurationNetworkNodeAddressList", EmitDefaultValue=false)]
        public List<ConfigurationNetworkNodeAddress> ConfigurationNetworkNodeAddressList { get; set; }
