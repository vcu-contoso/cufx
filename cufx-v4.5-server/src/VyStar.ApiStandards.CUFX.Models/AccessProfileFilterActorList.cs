...
{ 
    /// <summary>
    /// The access profile collection/array contains all the actors, for instance, that the credential set is authorized to access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
    public partial class AccessProfileFilterActorList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The person, place or thing that is accessing the application. </value>
