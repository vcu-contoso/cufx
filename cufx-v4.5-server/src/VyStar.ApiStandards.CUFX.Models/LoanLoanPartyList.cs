...
{ 
    /// <summary>
    /// A collection of party IDâ€™s that uniquely identify each party associated to this loan and additional fields on how the party relates to the loan. This list is in addition to the relationship parties, if available. 
    /// </summary>
    [DataContract]
    public partial class LoanLoanPartyList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>This includes each party ID and how it relates to the loan. </value>
        [DataMember(Name="loanParty", EmitDefaultValue=false)]
        public List<LoanParty> LoanParty { get; set; }
