...
{ 
    /// <summary>
    /// The list of party sub status that should have their associated parties either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class PartyFilterPartySubStatusList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A party sub status that should have its associated parties either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A party sub status that should have its associated parties either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="partySubStatus", EmitDefaultValue=false)]
        public List<string> PartySubStatus { get; set; }
