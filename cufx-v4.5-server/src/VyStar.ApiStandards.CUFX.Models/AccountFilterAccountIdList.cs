...
{ 
    /// <summary>
    /// The list of account IDs that should have their associated accounts either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class AccountFilterAccountIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// An account ID that should have its associated accounts either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>An account ID that should have its associated accounts either returned or affected by a read, update or delete request. </value>
