...
{ 
    /// <summary>
    /// The list of note creators that should have their associated records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class NotesFilterNoteCreatorList 
    {
        /// <summary>
        ...
        /// <summary>
        /// An Note Creator that should have its associated records either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>An Note Creator that should have its associated records either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="noteCode", EmitDefaultValue=false)]
        public List<string> NoteCode { get; set; }
