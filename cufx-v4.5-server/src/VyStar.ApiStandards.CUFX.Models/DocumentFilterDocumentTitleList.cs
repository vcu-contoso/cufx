...
{ 
    /// <summary>
    /// The list of document titles that should have their associated documents either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class DocumentFilterDocumentTitleList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A document title that should have its associated documents either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A document title that should have its associated documents either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="documentTitle", EmitDefaultValue=false)]
        public List<string> DocumentTitle { get; set; }
