...
{ 
    /// <summary>
    /// List of applicant IDs used for filtering on read, update or delete application service requests. 
    /// </summary>
    [DataContract]
    public partial class SimpleValidationRequestFilterApplicantIdList 
    {
        /// <summary>
