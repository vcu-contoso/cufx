...
{ 
    ...
    public partial class LinkedAccount 
    {
        ...
        /// <summary>
        /// Indicates the priority order of the account.  Priority 1 is the first account to hit, priority 2 is the second account to try, etc. 
        /// </summary>
        /// <value>Indicates the priority order of the account.  Priority 1 is the first account to hit, priority 2 is the second account to try, etc. </value>
