...
{ 
    /// <summary>
    /// The list of configuration IDs that should have their associated configurations either returned or affected by a read, update or delete configuration request. 
    /// </summary>
    [DataContract]
    public partial class ConfigurationFilterConfigurationIdList 
    {
        /// <summary>
        ...
        public List<string> ConfigurationId { get; set; }
