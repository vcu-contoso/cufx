...
{ 
    /// <summary>
    /// A collection of party IDâ€™s that uniquely identify each party associated to this relationship, along with how each party is related to the relationship. 
    /// </summary>
    [DataContract]
    public partial class RelationshipRelationshipPartyList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>A collection of fields required to relate this relationship with the identified parties and what level of ownership they have on the underlying accounts within the relationship. </value>
        [DataMember(Name="relationshipParty", EmitDefaultValue=false)]
        public List<RelationshipParty> RelationshipParty { get; set; }
