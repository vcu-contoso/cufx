...
{ 
    /// <summary>
    /// The list of party types that should have their associated parties either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class FeeScheduleFilterPartyTypeList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A party type that should have its associated parties either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A party type that should have its associated parties either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="partyType", EmitDefaultValue=false)]
        public List<PartyType> PartyType { get; set; }
