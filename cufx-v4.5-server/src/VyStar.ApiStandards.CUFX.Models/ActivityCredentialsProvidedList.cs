...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ActivityCredentialsProvidedList 
    {
        /// <summary>
        ...
        /// <summary>
        /// Combination of credentials necessary to get access to a system, i.e. a combination of username, password and token. 
        /// </summary>
        /// <value>Combination of credentials necessary to get access to a system, i.e. a combination of username, password and token. </value>
        [DataMember(Name="credentialGroup", EmitDefaultValue=false)]
        public List<CredentialGroup> CredentialGroup { get; set; }
