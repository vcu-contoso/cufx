...
{ 
    /// <summary>
    /// The list of collateral IDs that should have their associated collateral either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class CollateralFilterCollateralIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A collateral ID that should have its associated collateral either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A collateral ID that should have its associated collateral either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="collateralId", EmitDefaultValue=false)]
        public List<string> CollateralId { get; set; }
