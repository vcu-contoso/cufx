...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class NetworkNodeList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A network node that participates in the execution of a solution. Network nodes may be either hardware or software based instantiations of nodes. 
        /// </summary>
        /// <value>A network node that participates in the execution of a solution. Network nodes may be either hardware or software based instantiations of nodes. </value>
        [DataMember(Name="networkNode", EmitDefaultValue=false)]
        public List<NetworkNode> NetworkNode { get; set; }
