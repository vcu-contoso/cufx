...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationAppConfigurationAppParameterList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A list of configuration app parameter IDs that point to how an app parameter is set/specialized in the configuration for an app. 
        /// </summary>
        /// <value>A list of configuration app parameter IDs that point to how an app parameter is set/specialized in the configuration for an app. </value>
        [DataMember(Name="configurationAppParameter", EmitDefaultValue=false)]
        public List<ConfigurationAppParameter> ConfigurationAppParameter { get; set; }
