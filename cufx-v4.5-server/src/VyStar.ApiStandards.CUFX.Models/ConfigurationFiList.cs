...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationFiList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>List of financial institution within this configuration. </value>
        [DataMember(Name="financialInstitution", EmitDefaultValue=false)]
        public List<ConfigurationFinancialInstitution> FinancialInstitution { get; set; }
