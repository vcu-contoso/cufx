...
{ 
    /// <summary>
    /// The list of accounts from which the transfer or payment was made to. 
    /// </summary>
    [DataContract]
    public partial class BillPaymentFilterRecurringToAccountList 
    {
        /// <summary>
        ...
        public List<AccountBase> RecurringToAccount { get; set; }
