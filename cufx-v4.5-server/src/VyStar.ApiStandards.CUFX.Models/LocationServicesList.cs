...
{ 
    /// <summary>
    /// The services or features of the location.  For example, a branch could have a service such as a coin counter, or an ATM could accept check deposits. 
    /// </summary>
    [DataContract]
    public partial class LocationServicesList 
    {
        /// <summary>
        ...
        public List<ValuePair> ServicesList { get; set; }
