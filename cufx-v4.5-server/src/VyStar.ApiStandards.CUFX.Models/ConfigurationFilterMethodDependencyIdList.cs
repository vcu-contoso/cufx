...
{ 
    /// <summary>
    /// The list of method dependency IDs that should have their associated configurations either returned or affected by a read, update or delete configuration request. 
    /// </summary>
    [DataContract]
    public partial class ConfigurationFilterMethodDependencyIdList 
    {
        /// <summary>
        ...
        public List<string> MethodDependencyId { get; set; }
