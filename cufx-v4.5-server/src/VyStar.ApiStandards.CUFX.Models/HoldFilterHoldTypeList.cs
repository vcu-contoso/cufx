...
{ 
    /// <summary>
    /// The list of hold types that should have their associated hold records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class HoldFilterHoldTypeList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A hold type that should have its associated hold record either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A hold type that should have its associated hold record either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="holdType", EmitDefaultValue=false)]
        public List<HoldType> HoldType { get; set; }
