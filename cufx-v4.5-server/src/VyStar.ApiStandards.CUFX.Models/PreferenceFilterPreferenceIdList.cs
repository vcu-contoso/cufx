...
{ 
    /// <summary>
    /// The list of Preference IDs that should have their preference accounts either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class PreferenceFilterPreferenceIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A preference ID that should have its associated preference either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A preference ID that should have its associated preference either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="preferenceId", EmitDefaultValue=false)]
        public List<string> PreferenceId { get; set; }
