...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RemoteDepositImageValidationIssueList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Details related to an image validation issue. </value>
        [DataMember(Name="imageValidationIssue", EmitDefaultValue=false)]
        public List<ImageValidationIssue> ImageValidationIssue { get; set; }

        /// <summary>
        /// Description for when ImageValidationIssue is Other 
        /// </summary>
        /// <value>Description for when ImageValidationIssue is Other </value>
        [DataMember(Name="imageValidationIssueOther", EmitDefaultValue=false)]
        public string ImageValidationIssueOther { get; set; }
