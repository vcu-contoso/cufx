...
{ 
    ...
    {
        /// <summary>
        /// The registered device identification string.  The application should ensure that this is unique across all accounts. 
        /// </summary>
        /// <value>The registered device identification string.  The application should ensure that this is unique across all accounts. </value>
        ...
        /// <summary>
        /// If True, indicates that the device ID is registered with the institution. This will normally be True as the non-existence of the record means unregistered. However, this gives the flexibility to store devices that have at some point been registered but are now unregistered. 
        /// </summary>
        /// <value>If True, indicates that the device ID is registered with the institution. This will normally be True as the non-existence of the record means unregistered. However, this gives the flexibility to store devices that have at some point been registered but are now unregistered. </value>
        [DataMember(Name="isRegisteredFlag", EmitDefaultValue=true)]
        public bool IsRegisteredFlag { get; set; }
