...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class NetworkNodeNetworkNodeAddressList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Collection of network node addresses associated to the network node. </value>
        [DataMember(Name="networkNodeAddress", EmitDefaultValue=false)]
        public List<NetworkNodeAddress> NetworkNodeAddress { get; set; }
