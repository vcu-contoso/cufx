...
{ 
    /// <summary>
    /// The list of account MICRs that should have their associated accounts either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class AccountFilterAccountMicrList 
    {
        /// <summary>
        ...
        /// <summary>
        /// An account MICR that should have its associated accounts either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>An account MICR that should have its associated accounts either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="micrAccountNumber", EmitDefaultValue=false)]
        public List<string> MicrAccountNumber { get; set; }
