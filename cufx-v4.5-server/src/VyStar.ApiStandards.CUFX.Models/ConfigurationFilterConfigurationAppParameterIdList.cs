...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationFilterConfigurationAppParameterIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// The list of app parameters IDs that have been set/specialized for a configuration. 
        /// </summary>
        /// <value>The list of app parameters IDs that have been set/specialized for a configuration. </value>
        [DataMember(Name="configurationAppParameterId", EmitDefaultValue=false)]
        public List<string> ConfigurationAppParameterId { get; set; }
