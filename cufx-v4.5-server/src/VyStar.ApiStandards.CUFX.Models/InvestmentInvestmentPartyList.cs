...
{ 
    /// <summary>
    /// A collection of party IDâ€™s that uniquely identify each party associated to this investment and additional fields on how the party relates to the Investment. This list is in addition to the relationship parties if available. 
    /// </summary>
    [DataContract]
    public partial class InvestmentInvestmentPartyList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>This object is subset with additional fields of the party data. </value>
        [DataMember(Name="investmentParty", EmitDefaultValue=false)]
        public List<InvestmentParty> InvestmentParty { get; set; }
