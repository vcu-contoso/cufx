...
{ 
    /// <summary>
    /// List of artifact IDs that can be used by other objects to point to each artifact in a list. 
    /// </summary>
    [DataContract]
    public partial class ArtifactFilterArtifactIdList 
    {
        /// <summary>
        ...
        public List<ArtifactId> ArtifactId { get; set; }
