...
{ 
    /// <summary>
    /// A list of overdraft priority order values that should have their associated overdraft priority list entry either returned or affected by an update or delete request. 
    /// </summary>
    [DataContract]
    public partial class OverdraftPriorityListFilterPriorityList 
    {
        /// <summary>
        ...
        /// <summary>
        /// An overdraft priority order value that should have its associated overdraft priority list entry either returned or affected by an update or delete request. 
        /// </summary>
        /// <value>An overdraft priority order value that should have its associated overdraft priority list entry either returned or affected by an update or delete request. </value>
