...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionFilterCheckNumberList 
    {
        /// <summary>
        ...
        /// The list of check numbers that should be returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>The list of check numbers that should be returned or affected by a read, update or delete request. </value>
        [DataMember(Name="checkNumber", EmitDefaultValue=false)]
        public List<string> CheckNumber { get; set; }
