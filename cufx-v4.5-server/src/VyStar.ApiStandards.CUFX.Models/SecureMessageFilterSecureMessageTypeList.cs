...
{ 
    /// <summary>
    /// The list of secure message types that should have their associated secure messages either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class SecureMessageFilterSecureMessageTypeList 
    {
        /// <summary>
        ...
        [DataMember(Name="secureMessageType", EmitDefaultValue=false)]
        public List<SecureMessageType> SecureMessageType { get; set; }
