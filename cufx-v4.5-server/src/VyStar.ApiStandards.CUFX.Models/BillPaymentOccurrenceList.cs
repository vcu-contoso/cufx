...
{ 
    /// <summary>
    /// The bill payment collection/array contains all the bills, for instance, that the credential set is authorized to access at the Institution based on applied filters 
    /// </summary>
    [DataContract]
    public partial class BillPaymentOccurrenceList 
    {
        ...
        /// <summary>
        /// Gets or Sets BillPaymentOccurrence
        /// </summary>
        [DataMember(Name="billPaymentOccurrence", EmitDefaultValue=false)]
        public List<BillPaymentOccurrence> BillPaymentOccurrence { get; set; }
