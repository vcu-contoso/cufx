...
{ 
    /// <summary>
    /// The list of financial institution names that should have their associated financial institution records either returned or affected by a read, update or delete financial institution request. 
    /// </summary>
    [DataContract]
    public partial class FinancialInstitutionFilterFiNameList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>A valid financial institution name for this instance. </value>
        [DataMember(Name="fiName", EmitDefaultValue=false)]
        public List<string> FiName { get; set; }
