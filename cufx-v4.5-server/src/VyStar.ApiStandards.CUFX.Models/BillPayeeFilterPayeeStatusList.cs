...
{ 
    /// <summary>
    /// The list of bill payee statuses that should have their associated bill payee records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class BillPayeeFilterPayeeStatusList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A bill payee status that should have its associated bill payee records either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A bill payee status that should have its associated bill payee records either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="payeeStatus", EmitDefaultValue=false)]
        public List<PayeeStatus> PayeeStatus { get; set; }
