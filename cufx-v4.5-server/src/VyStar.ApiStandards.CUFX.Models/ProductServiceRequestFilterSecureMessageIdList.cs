...
{ 
    /// <summary>
    /// The list of secure message IDs that should have their associated secure messages either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class ProductServiceRequestFilterSecureMessageIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A secure message ID that should have its associated secure messages either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A secure message ID that should have its associated secure messages either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="secureMessageId", EmitDefaultValue=false)]
        public List<string> SecureMessageId { get; set; }
