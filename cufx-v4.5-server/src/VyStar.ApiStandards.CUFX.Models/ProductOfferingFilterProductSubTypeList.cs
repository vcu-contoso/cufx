...
{ 
    /// <summary>
    /// Product sub type filter used for making a request. If the list is nil then that indicates that no filters should be applied for product sub type. 
    /// </summary>
    [DataContract]
    public partial class ProductOfferingFilterProductSubTypeList 
    {
        /// <summary>
        ...
        /// <summary>
        /// Product sub type identifies how the product will be identified in the back end system. If none are provided, then all should be returned. 
        /// </summary>
        /// <value>Product sub type identifies how the product will be identified in the back end system. If none are provided, then all should be returned. </value>
        [DataMember(Name="productSubType", EmitDefaultValue=false)]
        public List<string> ProductSubType { get; set; }
