...
{ 
    /// <summary>
    /// The list of hold reason types that should have their associated hold records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class HoldFilterHoldReasonTypeList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A hold reason type that should have its associated holds either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A hold reason type that should have its associated holds either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="holdReasonType", EmitDefaultValue=false)]
        public List<HoldReasonType> HoldReasonType { get; set; }
