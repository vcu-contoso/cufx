...
{ 
    /// <summary>
    /// List of XSD paths and comments related to how the custom data sections are being used. This is information only and not processed by the system. 
    /// </summary>
    [DataContract]
    public partial class ServiceCustomDataUseList 
    {
        /// <summary>
        ...
        /// <summary>
        /// List of comments related to how the custom data sections are being used. This is informational only and not processed by the system. 
        /// </summary>
        /// <value>List of comments related to how the custom data sections are being used. This is informational only and not processed by the system. </value>
        [DataMember(Name="customDataUse", EmitDefaultValue=false)]
        public List<CustomDataUse> CustomDataUse { get; set; }
