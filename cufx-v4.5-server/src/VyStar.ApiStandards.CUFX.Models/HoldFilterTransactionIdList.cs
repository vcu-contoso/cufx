...
{ 
    /// <summary>
    /// The list of transaction IDs that should have their associated transaction records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class HoldFilterTransactionIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A transaction ID that should have its associated transaction records either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A transaction ID that should have its associated transaction records either returned or affected by a read, update or delete request. </value>
