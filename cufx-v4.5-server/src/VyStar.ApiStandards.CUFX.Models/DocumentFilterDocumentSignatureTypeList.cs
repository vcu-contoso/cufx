...
{ 
    /// <summary>
    /// The list of document signature types that should have their associated documents either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class DocumentFilterDocumentSignatureTypeList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A document signature type that should have its associated documents either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A document signature type that should have its associated documents either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="documentSignatureType", EmitDefaultValue=false)]
        public List<DocumentSignatureType> DocumentSignatureType { get; set; }
