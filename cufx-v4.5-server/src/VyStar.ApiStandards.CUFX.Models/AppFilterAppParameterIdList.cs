...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AppFilterAppParameterIdList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Collection of app parameter ids to return in a filter request. </value>
        [DataMember(Name="appParameterId", EmitDefaultValue=false)]
        public List<string> AppParameterId { get; set; }
