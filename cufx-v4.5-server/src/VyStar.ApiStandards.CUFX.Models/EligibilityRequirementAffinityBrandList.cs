...
{ 
    /// <summary>
    /// List of affinity brands where this requirement is applicable.  Some institutions have sub-financial institutions that are affinity branded with a different name than the parent.  If no affinity brands are listed, then the eligibility requirement is applicable for all. 
    /// </summary>
    [DataContract]
    public partial class EligibilityRequirementAffinityBrandList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>An affinity brand where the eligibility requirement is applicable. </value>
        [DataMember(Name="affinityBrand", EmitDefaultValue=false)]
        public List<string> AffinityBrand { get; set; }
