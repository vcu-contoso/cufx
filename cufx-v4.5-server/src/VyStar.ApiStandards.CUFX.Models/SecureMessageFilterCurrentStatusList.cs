...
{ 
    /// <summary>
    /// The list of secure message statuses that should have their associated secure messages either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class SecureMessageFilterCurrentStatusList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A secure message status that should have its associated secure messages either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A secure message status that should have its associated secure messages either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="secureMessageStatus", EmitDefaultValue=false)]
        public List<SecureMessageStatus> SecureMessageStatus { get; set; }
