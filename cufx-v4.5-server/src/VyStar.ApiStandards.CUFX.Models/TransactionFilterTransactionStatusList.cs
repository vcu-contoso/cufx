...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionFilterTransactionStatusList 
    {
        /// <summary>
        ...
        /// The list of transaction statuses that should be returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>The list of transaction statuses that should be returned or affected by a read, update or delete request. </value>
