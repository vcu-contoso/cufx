...
{ 
    /// <summary>
    /// List of preference settings related to an object. 
    /// </summary>
    [DataContract]
    public partial class ContactPreferenceSettingList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The preference setting related to the object </value>
        [DataMember(Name="preferenceSetting", EmitDefaultValue=false)]
        public List<PreferenceSetting> PreferenceSetting { get; set; }
