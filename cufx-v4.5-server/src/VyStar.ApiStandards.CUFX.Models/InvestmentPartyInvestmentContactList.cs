...
{ 
    /// <summary>
    /// The contact list collection/array contains all the contacts points, that the credential set is authorized to access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
    public partial class InvestmentPartyInvestmentContactList 
    {
        /// <summary>
        ...
        /// The contact list collection/array contains all the contacts points, that the credential set is authorized to access at the Institution based on applied filters. 
        /// </summary>
        /// <value>The contact list collection/array contains all the contacts points, that the credential set is authorized to access at the Institution based on applied filters. </value>
