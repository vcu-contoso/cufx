...
{ 
    /// <summary>
    /// The list of CollateralSubTypes that should have their associated collateral records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class CollateralFilterCollateralSubTypeList 
    {
        /// <summary>
        ...
        public List<string> CollateralSubType { get; set; }
