...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CollateralAircraftCollateral 
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="faaRegistrationNumber", EmitDefaultValue=false)]
        public string FaaRegistrationNumber { get; set; }

        /// <summary>
        /// Gets or Sets InspectionReportYN
        /// </summary>
        [DataMember(Name="inspectionReportYN", EmitDefaultValue=true)]
        public bool InspectionReportYN { get; set; }

        /// <summary>
        /// Gets or Sets FaaCoverLetterYN
        /// </summary>
        [DataMember(Name="faaCoverLetterYN", EmitDefaultValue=true)]
        public bool FaaCoverLetterYN { get; set; }

        /// <summary>
        /// Gets or Sets AircraftForCommercialUse
        /// </summary>
        [DataMember(Name="aircraftForCommercialUse", EmitDefaultValue=true)]
        public bool AircraftForCommercialUse { get; set; }

        /// <summary>
        /// Gets or Sets DescAvionicsEngines
        /// </summary>
        [DataMember(Name="descAvionicsEngines", EmitDefaultValue=false)]
        public string DescAvionicsEngines { get; set; }

        /// <summary>
        /// Gets or Sets DescOfLogBooks
        /// </summary>
        [DataMember(Name="descOfLogBooks", EmitDefaultValue=false)]
        public string DescOfLogBooks { get; set; }

        /// <summary>
        /// Gets or Sets AirportHomeBase
        /// </summary>
        [DataMember(Name="airportHomeBase", EmitDefaultValue=false)]
        public string AirportHomeBase { get; set; }

        /// <summary>
        /// The number of hours on the aircraft. 
        /// </summary>
        /// <value>The number of hours on the aircraft. </value>
