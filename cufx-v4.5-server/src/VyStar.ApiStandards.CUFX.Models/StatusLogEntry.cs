...
{ 
    /// <summary>
    /// The dates and times that the secureMessage changed status to drafted, sent, read, replied, forwarded, etc. 
    /// </summary>
    [DataContract]
    public partial class StatusLogEntry 
    {
        ...
        [DataMember(Name="messageAccessProfileId", EmitDefaultValue=false)]
        public string MessageAccessProfileId { get; set; }

        /// <summary>
        /// The date and time that the secure message was drafted, read, sent, replied, forwarded, etc.  See Status for valid events.  The date/time should be ISO 8601 UTC format. yyyy-mm-ddThh:mmZ (2011-03-28T12:00Z) and yyyy-mm-dd (2011-03-28) formats are supported.  The time is assumed to be 00:00Z if omitted. 
        /// </summary>
        /// <value>The date and time that the secure message was drafted, read, sent, replied, forwarded, etc.  See Status for valid events.  The date/time should be ISO 8601 UTC format. yyyy-mm-ddThh:mmZ (2011-03-28T12:00Z) and yyyy-mm-dd (2011-03-28) formats are supported.  The time is assumed to be 00:00Z if omitted. </value>
