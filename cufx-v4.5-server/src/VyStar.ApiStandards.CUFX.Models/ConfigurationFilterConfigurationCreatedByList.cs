...
{ 
    /// <summary>
    /// The list of users that created a configuration that should have their associated configurations either returned or affected by a read, update or delete configuration request. 
    /// </summary>
    [DataContract]
    public partial class ConfigurationFilterConfigurationCreatedByList 
    {
        /// <summary>
        ...
        /// <summary>
        /// The unique identifier for the user that created the configuration. 
        /// </summary>
        /// <value>The unique identifier for the user that created the configuration. </value>
        [DataMember(Name="configurationCreatedBy", EmitDefaultValue=false)]
        public List<string> ConfigurationCreatedBy { get; set; }
