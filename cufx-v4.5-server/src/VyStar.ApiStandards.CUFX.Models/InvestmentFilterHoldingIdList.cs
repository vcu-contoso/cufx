...
{ 
    /// <summary>
    /// The list of holding IDs that should have their associated accounts either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class InvestmentFilterHoldingIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// An holding ID that should have its associated accounts either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>An holding ID that should have its associated accounts either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="holdingId", EmitDefaultValue=false)]
        public List<string> HoldingId { get; set; }
