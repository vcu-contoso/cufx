...
{ 
    /// <summary>
    /// The interest rate list collection/array contains all the possible interest rates for a product offering. This can be used for tiered pricing, risk pricing or effective date pricing. 
    /// </summary>
    [DataContract]
    public partial class ProductOfferingInterestRateList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Collection of fields that define an interest rate for a specific product offering at the institution level. </value>
