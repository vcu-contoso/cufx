...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class OverdraftPriorityOverdraftPriorityAccountList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>An entry in an accounts overdraft priority list, i.e. where should funds be pulled from to cover the overdraft and its order based on priority. </value>
        [DataMember(Name="overdraftPriorityAccount", EmitDefaultValue=false)]
        public List<OverdraftPriorityAccount> OverdraftPriorityAccount { get; set; }
