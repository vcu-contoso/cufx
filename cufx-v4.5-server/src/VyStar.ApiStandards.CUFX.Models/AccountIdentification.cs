...
{ 
    ...
    public partial class AccountIdentification 
    {
        ...
        /// <summary>
        /// AccountToFromIndicator is used to filter for account identifications in messages that have TO and FROM account structure. If a value is not present then the search criteria should evaluate both To and From account structures if applicable. Return or affect accounts identified as the To account, or destination account. Return or affect accounts identified as the From account, or source account. 
        /// </summary>
        /// <value>AccountToFromIndicator is used to filter for account identifications in messages that have TO and FROM account structure. If a value is not present then the search criteria should evaluate both To and From account structures if applicable. Return or affect accounts identified as the To account, or destination account. Return or affect accounts identified as the From account, or source account. </value>
        [TypeConverter(typeof(CustomEnumConverter<AccountToFromIndicatorEnum>))]
        [JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public enum AccountToFromIndicatorEnum
        {
        ...
        /// </summary>
        /// <value>AccountToFromIndicator is used to filter for account identifications in messages that have TO and FROM account structure. If a value is not present then the search criteria should evaluate both To and From account structures if applicable. Return or affect accounts identified as the To account, or destination account. Return or affect accounts identified as the From account, or source account. </value>
        [DataMember(Name="accountToFromIndicator", EmitDefaultValue=true)]
        public AccountToFromIndicatorEnum AccountToFromIndicator { get; set; }
