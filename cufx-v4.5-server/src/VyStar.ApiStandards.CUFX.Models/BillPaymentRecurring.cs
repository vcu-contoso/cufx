...
{ 
    /// <summary>
    /// Foreign keys to party and relationship are bound through the from account id of the bill payment recurring record. The status of each individual bill payment occurrence can be found through the funds transfer recurring occurrenceIDlist. 
    /// </summary>
    [DataContract]
