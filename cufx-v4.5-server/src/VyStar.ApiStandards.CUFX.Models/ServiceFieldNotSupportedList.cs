...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ServiceFieldNotSupportedList 
    {
        /// <summary>
        ...
        /// <summary>
        /// Describe which fields are not supported by specifying the XSD path and any comments as to why it isnt supported. 
        /// </summary>
        /// <value>Describe which fields are not supported by specifying the XSD path and any comments as to why it isnt supported. </value>
        [DataMember(Name="fieldNotSupported", EmitDefaultValue=false)]
        public List<FieldNotSupported> FieldNotSupported { get; set; }
