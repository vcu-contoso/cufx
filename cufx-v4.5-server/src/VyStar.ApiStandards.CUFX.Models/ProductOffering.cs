...
{ 
    ...
    public partial class ProductOffering 
    {
        ...
        /// <summary>
        /// Gets or Sets SystemProductKeys
        /// </summary>
        [DataMember(Name="systemProductKeys", EmitDefaultValue=false)]
        public AccessProfileCustomData SystemProductKeys { get; set; }

        /// <summary>
        /// Description of the product, i.e. Visa Classic, MasterCard Gold, Electronic Checking, New Auto, etc. 
        /// </summary>
        /// <value>Description of the product, i.e. Visa Classic, MasterCard Gold, Electronic Checking, New Auto, etc. </value>
        ...
        /// </summary>
        /// <value>If true, this product offering is part of a points rewards program. </value>
        [DataMember(Name="pointsRewardsProgram", EmitDefaultValue=true)]
        public bool PointsRewardsProgram { get; set; }

        /// <summary>
        /// Gets or Sets InterestRateList
        /// </summary>
        [DataMember(Name="interestRateList", EmitDefaultValue=false)]
        public ProductOfferingInterestRateList InterestRateList { get; set; }

        /// <summary>
        /// The company that sponsors the card (i.e. Visa, MasterCard, American Express, etc.). Only applies to card-based products. 
        /// </summary>
        /// <value>The company that sponsors the card (i.e. Visa, MasterCard, American Express, etc.). Only applies to card-based products. </value>
