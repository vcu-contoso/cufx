...
{ 
    /// <summary>
    /// The bill payment collection/array contains all the recurring bills, for instance, that the credential set is authorized to access at the Institution based on applied filters 
    /// </summary>
    [DataContract]
    public partial class BillPaymentRecurringList 
    {
        ...
        /// <summary>
        /// Gets or Sets BillPaymentRecurring
        /// </summary>
        [DataMember(Name="billPaymentRecurring", EmitDefaultValue=false)]
        public List<BillPaymentRecurring> BillPaymentRecurring { get; set; }
