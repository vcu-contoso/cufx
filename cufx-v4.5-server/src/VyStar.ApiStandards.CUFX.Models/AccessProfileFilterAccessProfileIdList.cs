...
{ 
    /// <summary>
    /// The access profile collection/array contains all the access profiles, for instance, that the credential set is authorized to access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
    public partial class AccessProfileFilterAccessProfileIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// The access profile ID list is a collection of attributes that describe the device used to access an application. This profile may describe a mobile phone, laptop, personal computer, IVR system, or other. 
        /// </summary>
        /// <value>The access profile ID list is a collection of attributes that describe the device used to access an application. This profile may describe a mobile phone, laptop, personal computer, IVR system, or other. </value>
        [DataMember(Name="accessProfileId", EmitDefaultValue=false)]
        public List<string> AccessProfileId { get; set; }
