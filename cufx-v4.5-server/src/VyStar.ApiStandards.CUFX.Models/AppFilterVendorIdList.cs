...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AppFilterVendorIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// The vendor ID is a unique identifier which identifies the vendor that is creating a message. The vendor ID is assigned by the FI or established in concert by the vendor and FI. 
        /// </summary>
        /// <value>The vendor ID is a unique identifier which identifies the vendor that is creating a message. The vendor ID is assigned by the FI or established in concert by the vendor and FI. </value>
