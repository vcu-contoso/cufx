...
{ 
    /// <summary>
    /// The methods that must be executed first before this method can be executed. This allows for orchestration differences amongst different implementations of back end endpoints. For example: Does the party need to be created first or after the account is created? 
    /// </summary>
    [DataContract]
    public partial class ServiceMethodListMethodMethodDependencyList 
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets MethodDependency
        /// </summary>
        [DataMember(Name="methodDependency", EmitDefaultValue=false)]
        public ServiceMethodListMethodMethodDependencyListMethodDependency MethodDependency { get; set; }
