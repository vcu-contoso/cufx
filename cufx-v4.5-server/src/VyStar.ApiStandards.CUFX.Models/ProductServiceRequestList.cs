...
{ 
    /// <summary>
    /// The product service request list collection/array contains all the product service requests, for instance, that the credential set is authorized to access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
    public partial class ProductServiceRequestList 
    {
        ...
        /// </summary>
        /// <value>Collection of fields for a product service request. </value>
        [DataMember(Name="productServiceRequest", EmitDefaultValue=false)]
        public List<ProductServiceRequest> ProductServiceRequest { get; set; }
