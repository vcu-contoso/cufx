...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AccountFilterAccountStatusList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Collection of account status and sub status pairs to return in a filter request. </value>
        [DataMember(Name="accountStatusPair", EmitDefaultValue=false)]
        public List<AccountStatusPair> AccountStatusPair { get; set; }
