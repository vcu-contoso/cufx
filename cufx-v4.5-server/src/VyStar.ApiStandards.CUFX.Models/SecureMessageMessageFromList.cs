...
{ 
    /// <summary>
    /// Can serve as a list of users that either receive or send a message. Can also serve as a list of secure message users that should have their associated secure messages returned or affected by a read, update or delete request when filtering. 
    /// </summary>
    [DataContract]
    public partial class SecureMessageMessageFromList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A secure message type that should have its associated secure messages either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A secure message type that should have its associated secure messages either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="secureMessageUser", EmitDefaultValue=false)]
        public List<SecureMessageUser> SecureMessageUser { get; set; }
