...
{ 
    /// <summary>
    /// The list of bill IDs that should have their associated bills either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class BillFilterBillIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A bill id that should have its associated bill data either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A bill id that should have its associated bill data either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="billId", EmitDefaultValue=false)]
        public List<string> BillId { get; set; }
