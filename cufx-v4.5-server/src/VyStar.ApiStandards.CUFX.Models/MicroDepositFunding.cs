...
{ 
    ...
    {
        /// <summary>
        /// Unique id of the micro funding deposit. This id will have a relationship to multiple micro deposit ids as presented as part of a single micro deposit transaction. 
        /// </summary>
        /// <value>Unique id of the micro funding deposit. This id will have a relationship to multiple micro deposit ids as presented as part of a single micro deposit transaction. </value>
        [DataMember(Name="microDepositFundingId", EmitDefaultValue=false)]
        public string MicroDepositFundingId { get; set; }
        ...
        [TypeConverter(typeof(CustomEnumConverter<SourceAccountTypeEnum>))]
        ...
        /// </summary>
        /// <value>Checking account, i.e., checks can be written against the account. Money market accounts can be included here or in money markets.  Its up to the institution. Savings and club accounts.  This can optionally include CDs, but its up to the institution. Auto loans, etc. Loans that are NOT lines of credit or credit cards. Loan behind the credit card.  Note the actual card information in the card object. Loan that is a line of credit but NOT a credit card. Loan that is made in exchange for taking title of property. Investment accounts such as brokerage and this can optionally include CDs and/or money markets, but its up to the institution. This account is a special type of checking account connected to a pre-paid card. Other account type. Loan that is made in installments. Loan is typically unsecured. This enumeration is considered deprecated. Recommend using account type Loan and subAccount of Installment. Loan that is a made to a business organization. This enumeration is considered deprecated. Recommend using account type Loan and subAccount of Commercial. Line of Credit that is a made to a business organization. This enumeration is considered deprecated. Recommend using account type Loan and subAccount of CommercialLineOfCredit. A general ledger account of the financial institution. A loan account type that has not been prevously defined. This enumeration is considered deprecated. Recommend using account type loan and subAccount of OtherLoan. </value>
        [DataMember(Name="sourceAccountType", EmitDefaultValue=true)]
        public SourceAccountTypeEnum SourceAccountType { get; set; }
        ...
        [DataMember(Name="sourceAccountSubType", EmitDefaultValue=false)]
        public string SourceAccountSubType { get; set; }

        /// <summary>
        /// External account that needs to be verified. Direct reference to the account structure was avoided in this instance to avoid inclusion of numerous fields not needed for a microdeposit. 
        /// </summary>
        /// <value>External account that needs to be verified. Direct reference to the account structure was avoided in this instance to avoid inclusion of numerous fields not needed for a microdeposit. </value>
        [DataMember(Name="externalAccountID", EmitDefaultValue=false)]
        public string ExternalAccountID { get; set; }

        /// <summary>
        /// Routing number for the external account. Direct reference to the account structure was avoided in this instance to avoid inclusion of numerous fields not needed for a microdeposit. 
        /// </summary>
        /// <value>Routing number for the external account. Direct reference to the account structure was avoided in this instance to avoid inclusion of numerous fields not needed for a microdeposit. </value>
        [DataMember(Name="externalRoutingNumber", EmitDefaultValue=false)]
        public string ExternalRoutingNumber { get; set; }

        /// <summary>
        /// Gets or Sets MicroDepositList
        /// </summary>
        [DataMember(Name="microDepositList", EmitDefaultValue=false)]
        public MicroDepositFundingMicroDepositList MicroDepositList { get; set; }
