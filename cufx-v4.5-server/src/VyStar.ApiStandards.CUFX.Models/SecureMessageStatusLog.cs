...
{ 
    /// <summary>
    /// The dates and times corresponding to the secure messages statuses, i.e. drafted, sent, read, replied, forwarded, etc. 
    /// </summary>
    [DataContract]
    public partial class SecureMessageStatusLog 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Status entry at the point in time when the secure message was at a given status. </value>
        [DataMember(Name="statusLogEntry", EmitDefaultValue=false)]
        public List<StatusLogEntry> StatusLogEntry { get; set; }
