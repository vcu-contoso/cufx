...
{ 
    /// <summary>
    /// The list of location IDs that should have their associated location data either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class LocationFilterLocationIdList 
    {
        /// <summary>
