...
{ 
    /// <summary>
    /// The list of Configuration FI App Parameter IDs that should have their associated configurations either returned or affected by a read, update or delete configuration request. 
    /// </summary>
    [DataContract]
    public partial class ConfigurationFilterConfigurationFiAppParameterIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// The unique identifier for the configuration, financial institution and App. 
        /// </summary>
        /// <value>The unique identifier for the configuration, financial institution and App. </value>
        [DataMember(Name="configurationFiAppParameterId", EmitDefaultValue=false)]
        public List<string> ConfigurationFiAppParameterId { get; set; }
