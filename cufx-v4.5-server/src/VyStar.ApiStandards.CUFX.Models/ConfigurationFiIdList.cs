...
{ 
    /// <summary>
    /// The valid financial institution list for this instance. Identifies that these configuration parameters are related to these financial institutions. 
    /// </summary>
    [DataContract]
    public partial class ConfigurationFiIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A valid financial institution for this instance. Identifies that these configuration parameters are related to this financial institution. 
        /// </summary>
        /// <value>A valid financial institution for this instance. Identifies that these configuration parameters are related to this financial institution. </value>
        [DataMember(Name="fiId", EmitDefaultValue=false)]
        public List<string> FiId { get; set; }
