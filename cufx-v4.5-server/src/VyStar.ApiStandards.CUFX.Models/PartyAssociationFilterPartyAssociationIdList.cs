...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PartyAssociationFilterPartyAssociationIdList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The unique identifier to be filtered on. </value>
        [DataMember(Name="partyAssociationId", EmitDefaultValue=false)]
        public List<string> PartyAssociationId { get; set; }
