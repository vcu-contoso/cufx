...
{ 
    /// <summary>
    /// Product type filter for making a request. If the list is nil then that indicates that no filters should be applied for product type. 
    /// </summary>
    [DataContract]
    public partial class ApplicationFilterProductTypeList 
    {
        /// <summary>
        ...
        /// <summary>
        /// Defines a general category for the product type to filter on.  If none are provided, then all should be returned. 
        /// </summary>
        /// <value>Defines a general category for the product type to filter on.  If none are provided, then all should be returned. </value>
        [DataMember(Name="productType", EmitDefaultValue=false)]
        public List<AccountType> ProductType { get; set; }
