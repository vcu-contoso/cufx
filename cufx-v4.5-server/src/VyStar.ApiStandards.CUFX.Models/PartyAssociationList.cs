...
{ 
    /// <summary>
    /// The party association list collection/array contains all the party associations, for instance, that the credential set is authorized to access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
    public partial class PartyAssociationList 
    {
        ...
        /// <summary>
        /// Gets or Sets PartyAssociation
        /// </summary>
        [DataMember(Name="partyAssociation", EmitDefaultValue=false)]
        public List<PartyAssociation> PartyAssociation { get; set; }
