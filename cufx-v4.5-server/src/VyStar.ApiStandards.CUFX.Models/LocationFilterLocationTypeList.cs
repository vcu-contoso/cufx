...
{ 
    /// <summary>
    /// The list of location types that should have their associated location data either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class LocationFilterLocationTypeList 
    {
        /// <summary>
