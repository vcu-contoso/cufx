...
{ 
    /// <summary>
    /// The list of Configuration FI IDs that should have their associated configurations either returned or affected by a read, update or delete configuration request. 
    /// </summary>
    [DataContract]
    public partial class ConfigurationFilterConfigurationFiIdList 
    {
        /// <summary>
        ...
        public List<string> ConfigurationFiId { get; set; }
