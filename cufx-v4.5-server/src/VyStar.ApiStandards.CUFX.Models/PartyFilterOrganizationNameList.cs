...
{ 
    /// <summary>
    /// The list of organization names that should have their associated parties either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class PartyFilterOrganizationNameList 
    {
        /// <summary>
        ...
        /// <summary>
        /// An organization name that should have its associated parties either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>An organization name that should have its associated parties either returned or affected by a read, update or delete request. </value>
