...
{ 
    /// <summary>
    /// The list of batch ids that should have their associated payments or transfers either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class BillPaymentFilterBatchIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A batch id that should have its associated payments or transfers either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A batch id that should have its associated payments or transfers either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="batchId", EmitDefaultValue=false)]
        public List<string> BatchId { get; set; }
