...
{ 
    /// <summary>
    /// The product offering collection/array contains all the possible product types for an instance that the credential set is authorized to access at the institution based on applied filters. 
    /// </summary>
    [DataContract]
    public partial class ProductOfferingList 
    {
        ...
        /// </summary>
        /// <value>Collection of fields that define a specific product offering at the institution level. </value>
        [DataMember(Name="productOffering", EmitDefaultValue=false)]
        public List<ProductOffering> ProductOffering { get; set; }
