...
{ 
    /// <summary>
    /// The list of Configuration FI App IDs that should have their associated configurations either returned or affected by a read, update or delete configuration request. 
    /// </summary>
    [DataContract]
    public partial class ConfigurationFilterConfigurationFiAppIdList 
    {
        /// <summary>
        ...
        public List<string> ConfigurationFiAppId { get; set; }
