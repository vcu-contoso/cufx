...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AccountPartyIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A party ID that should have its associated parties either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A party ID that should have its associated parties either returned or affected by a read, update or delete request. </value>
