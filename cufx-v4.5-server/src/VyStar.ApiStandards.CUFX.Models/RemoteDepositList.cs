...
{ 
    ...
    public partial class RemoteDepositList 
    {
        ...
        /// </summary>
        /// <value>Details related to a remote deposit item. </value>
        [DataMember(Name="remoteDeposit", EmitDefaultValue=false)]
        public List<RemoteDeposit> RemoteDeposit { get; set; }
