...
{ 
    /// <summary>
    /// The list of filter options for services requesting relationship data.  The options can be used in combination or by themselves.  It is up to the data source to either return or affect the data requested or return a standard error identifying why the request was rejected. 
    /// </summary>
    [DataContract]
    public partial class RelationshipFilter 
    {
        ...
        /// <summary>
        /// Gets or Sets RelationshipStatusList
        /// </summary>
        [DataMember(Name="relationshipStatusList", EmitDefaultValue=false)]
        public RelationshipFilterRelationshipStatusList RelationshipStatusList { get; set; }
