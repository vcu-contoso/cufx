...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class StatusSubstitutionList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Optional substitution to send data to the end point about which fields may be in error and/or which values may be out-of-range.  The error message can be scanned for potential substitution IDs (for example %1, %2) and replaced with the value from the substitution list.  This is useful for when an end point wants to support multiple languages or wants all of the message to be reconfigured for better consumption. </value>
