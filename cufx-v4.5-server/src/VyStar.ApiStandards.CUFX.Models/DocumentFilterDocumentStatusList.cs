...
{ 
    /// <summary>
    /// The list of document statuses that should have their associated documents either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class DocumentFilterDocumentStatusList 
    {
        /// <summary>
        ...
        /// <summary>
        /// A document status that should have its associated documents either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>A document status that should have its associated documents either returned or affected by a read, update or delete request. </value>
