...
{ 
    /// <summary>
    /// The custom data section allows the flexibility to add additional information to the message. This should be utilized as a last resort. Any use should result in requested modifications to the message. 
    /// </summary>
    [DataContract]
    public partial class AccessProfileCustomData 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Each combination of name and value. </value>
        [DataMember(Name="valuePair", EmitDefaultValue=false)]
        public List<ValuePair> ValuePair { get; set; }
