...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class WireFilterWireTransferTypeList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Wire transfer type to be returned or affected by a read, update or delete request. </value>
        [DataMember(Name="wireTransferType", EmitDefaultValue=false)]
        public List<WireTransferType> WireTransferType { get; set; }
