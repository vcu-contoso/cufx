...
{ 
    /// <summary>
    /// The list of payments or transfers occurrence statuss that should have their associated occurrence status either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class BillPaymentFilterOccurrenceStatusList 
    {
        /// <summary>
        ...
        /// <summary>
        /// An occurrence status that should have its associated payments or transfers either returned or affected by a read, update or delete request. 
        /// </summary>
        /// <value>An occurrence status that should have its associated payments or transfers either returned or affected by a read, update or delete request. </value>
        [DataMember(Name="occurrenceStatus", EmitDefaultValue=false)]
        public List<OccurrenceStatus> OccurrenceStatus { get; set; }
