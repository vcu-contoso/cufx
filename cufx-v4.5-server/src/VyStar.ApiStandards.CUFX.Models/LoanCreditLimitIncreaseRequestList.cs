...
{ 
    /// <summary>
    /// The list of credit limit increase request that should have their associated loans either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class LoanCreditLimitIncreaseRequestList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>A credit limit increase request. </value>
        [DataMember(Name="creditLimitIncreaseRequest", EmitDefaultValue=false)]
        public List<CreditLimitIncreaseRequest> CreditLimitIncreaseRequest { get; set; }
