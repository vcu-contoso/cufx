...
{ 
    /// <summary>
    /// An entry in an accounts overdraft priority list, i.e. where should funds be pulled from to cover the overdraft and its order based on priority. 
    /// </summary>
    [DataContract]
    public partial class OverdraftPriorityAccount 
    {
        /// <summary>
        /// The overdraft priority ID is a persistent and unique identifier for each entry in an accounts overdraft priority list. 
        /// </summary>
        /// <value>The overdraft priority ID is a persistent and unique identifier for each entry in an accounts overdraft priority list. </value>
        [DataMember(Name="overdraftPriorityId", EmitDefaultValue=false)]
        public string OverdraftPriorityId { get; set; }

        /// <summary>
        /// Indicates the numeric priority (in ascending order) of accounts to be used as sources of overdraft protection. 
        /// </summary>
        /// <value>Indicates the numeric priority (in ascending order) of accounts to be used as sources of overdraft protection. </value>
