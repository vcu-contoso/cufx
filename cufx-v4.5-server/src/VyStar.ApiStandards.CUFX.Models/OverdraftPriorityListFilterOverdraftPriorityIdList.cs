...
{ 
    /// <summary>
    /// A list of overdraft priority IDs that should have their associated overdraft priority list entry either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class OverdraftPriorityListFilterOverdraftPriorityIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// An overdraft priority ID that should have its associated overdraft priority list entry either returned or affected by an update or delete request. 
        /// </summary>
        /// <value>An overdraft priority ID that should have its associated overdraft priority list entry either returned or affected by an update or delete request. </value>
        [DataMember(Name="overdraftPriorityId", EmitDefaultValue=false)]
        public List<string> OverdraftPriorityId { get; set; }
