...
{ 
    /// <summary>
    /// Product sub type filter for making a request.  If the list is nil then that indicates that no filters should be applied for product sub type. 
    /// </summary>
    [DataContract]
    public partial class PermissionListFilterResourcesProductIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// Product ID is a unique identifier for the product. If none are provided, then no filters should be applied by product ID. 
        /// </summary>
        /// <value>Product ID is a unique identifier for the product. If none are provided, then no filters should be applied by product ID. </value>
