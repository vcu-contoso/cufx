...
{ 
    /// <summary>
    /// Definition of the list of product service request IDs that can be used by other objects to point to each product service request in a list. 
    /// </summary>
    [DataContract]
    public partial class FieldFilterProductServiceRequestIdList 
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets ProductServiceRequestId
        /// </summary>
        [DataMember(Name="productServiceRequestId", EmitDefaultValue=false)]
        public List<string> ProductServiceRequestId { get; set; }
