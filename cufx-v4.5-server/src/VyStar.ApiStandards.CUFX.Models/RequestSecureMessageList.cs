...
{ 
    /// <summary>
    /// The secure messages collection/array list contains all the secure messages or secure message templates, for instance, that the credential set is authorized to access at the Institution based on applied filters. 
    /// </summary>
    [DataContract]
    public partial class RequestSecureMessageList 
    {
        /// <summary>
        ...
        /// <summary>
        /// The secure message defines the information sent and then received by two or more parties. It also relates secure messages to the sending and receiving party(ies), and potentially to the relationship and/or account(s) to which the secure message is bound.  The information and message statuses below are in the context of the user that is viewing the message. 
        /// </summary>
        /// <value>The secure message defines the information sent and then received by two or more parties. It also relates secure messages to the sending and receiving party(ies), and potentially to the relationship and/or account(s) to which the secure message is bound.  The information and message statuses below are in the context of the user that is viewing the message. </value>
        [DataMember(Name="secureMessage", EmitDefaultValue=false)]
        public List<SecureMessage> SecureMessage { get; set; }
