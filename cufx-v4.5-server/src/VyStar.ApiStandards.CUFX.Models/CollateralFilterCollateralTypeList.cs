...
{ 
    /// <summary>
    /// The list of collateral types that should have their associated collateral records either returned or affected by a read, update or delete request. 
    /// </summary>
    [DataContract]
    public partial class CollateralFilterCollateralTypeList 
    {
        /// <summary>
        ...
        [DataMember(Name="collateralType", EmitDefaultValue=false)]
        public List<CollateralType> CollateralType { get; set; }
