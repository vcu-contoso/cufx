...
{ 
    /// <summary>
    /// The list of financial institution statuses that should have their associated financial institution records either returned or affected by a read, update or delete financial institution request. 
    /// </summary>
    [DataContract]
    public partial class FinancialInstitutionFilterFiStatusList 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>A valid financial institution status for this instance. </value>
        [DataMember(Name="fiStatus", EmitDefaultValue=false)]
        public List<FinancialInstitutionStatus> FiStatus { get; set; }
